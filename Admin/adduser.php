...
<input type="text" name="field2" placeholder="Contact no">
...
<label>Email</label>
<input type="email" name="field6" placeholder="Email"></textarea>
<label>Password</label>
<input type="password" class="seven" name="field7" placeholder="Password"></textarea>    
</fieldset>
...
if(isset($_POST['submit'])){
    ...
    $provience = $_POST['field3'];
    $wardmuni = $_POST['field4'];
    $wardmunino = $_POST['field5'];
    $email = $_POST['field6'];
    $pass = $_POST['field7'];

    $insertquery = "insert into user(fullname,contactno,provienceno,wardormuni,wardmunino,email,password)
                   values('$fullname','$contactno','$provience','$wardmuni','$wardmunino','$email','$pass')";
    
    $insertquery1 = "insert into login(email,password)
                   values('$email','$pass')";
