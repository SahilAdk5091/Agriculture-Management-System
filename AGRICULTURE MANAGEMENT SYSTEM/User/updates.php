...
if(isset($_POST['submit'])){
    ...
    echo $fname = $_POST['field1'];
    echo $prod = $_POST['field2'];
    echo $cname = $_POST['field3'];
    echo $frate = $_POST['field4'];
    echo $mrate = $_POST['field5'];
    echo $prov = $_POST['field6'];
$sql = "update `cropdetails` set id=$id,Farmername='$fname',Production=$prod,Cropname='$cname',
Farmerrate=$frate,Marketrate=$mrate,Provience=$prov where id=$idupdate ";
...
<input type="text"  value="<?php echo "$fn"?>" name="field1" placeholder="Farmer name">
<label>Production</label>
<input type="text" value="<?php echo "$pro"?>" name="field2" placeholder="Production">
...
<input type="text" value="<?php echo "$fr"?>" name="field4" placeholder="Farmer rate">
<label>Market rate</label>
<input type="text" value="<?php echo "$mr"?>" name="field5" placeholder="Market rate">
